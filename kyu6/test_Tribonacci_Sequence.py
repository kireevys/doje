from kyu6.Tribonacci_Sequence import tribonacci


def test_tribonacci(test):
    ...
    test.assert_equals(tribonacci([145, 199, 74], 1), [145])
    test.assert_equals(tribonacci([65, 61, 3], 2), [65, 61])
